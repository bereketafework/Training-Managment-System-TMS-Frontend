        ...
        <div class="flex mt-2">
            ...
            <v-overlay v-model="overlay" class="!flex !justify-center items-center">
                <v-card flat class="bg-slate-300">
                    <span class="flex justify-center border-b-[1px] text-3xl p-4">payment Method Registration Form</span>
            ...
            <v-spacer></v-spacer>
            <span class="flex justify-center border-b-[1px] text-3xl">List of payment Method</span>
            <v-spacer></v-spacer>
